...
function setServerPermission(guildId, allowed) {
    allowedServers.set(guildId, allowed);
}

function getServerPermission(guildId) {
    return allowedServers.get(guildId) !== false;
}

async function handlePermissionCommand(interaction, langCode) {
